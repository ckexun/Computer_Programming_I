...
int main()
{
    ifstream inFile("C:\\Users\\a5104\\OneDrive\\桌面\\Assignment 4\\Polynomials.dat", ios::in | ios::binary);
...
int main() {
    // division
    int coef_a[20] = { -27, 81, -9, 18, -45 };
    int exp_a[20] = { 1, 2, 4, 5, 6 };
    int size_a = 5;

    int coef_b[20] = { -3, 9, 2, -5 };
    int exp_b[20] = { 1, 2, 5, 6 };
    int size_b = 4;
    ...
    output(coef_a, exp_a, size_a);
    output(coef_b, exp_b, size_b);
    cout << "----------------------\n";
    division(coef_a, exp_a, size_a,
        coef_b, exp_b, size_b,
        coef_q, exp_q, size_q,
        coef_r, exp_r, size_r);
    cout << "----------------------\n";
    output(coef_a, exp_a, size_a);
    output(coef_b, exp_b, size_b);
    output(coef_q, exp_q, size_q);
    output(coef_r, exp_r, size_r);
}*/
    ...
    int remainderCoef[], int remainderExpon[], int& remainderSize)
{
    ...
    for (int i = quotientSize - 1; i >= 0; i--)
    {
        ...
        int bufferExpon[20] = {}, bufferCoef[20] = {}, bufferSize = 1;
